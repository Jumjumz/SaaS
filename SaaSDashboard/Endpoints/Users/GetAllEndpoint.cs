...
public class GetAllEndpoint : EndpointWithoutRequest<List<GetAllDto>, GetAllMapper>
{
    ...
    public override async Task HandleAsync(CancellationToken ct)
    {
        ...
        List<GetAllDto> response = Map.FromEntity(users); // var response = users.Select(Map.FromEntity).ToList() though you dont need this if you implement the conversion in the mapper
